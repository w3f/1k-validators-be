...
run_tests() {
    ...
    wait_pod_ready mongodb-replicaset-0 kusama
    wait_pod_ready mongodb-replicaset-1 kusama
    ...
    wait_pod_ready mongodb-replicaset-0 polkadot
    wait_pod_ready mongodb-replicaset-1 polkadot
